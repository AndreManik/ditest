...
public class DiDemoApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  name: " + fakeDataSource.getUser() + ",\n" +
                           "  pass: " + fakeDataSource.getPassword() + ", \n" +
                           "  url:  " + fakeDataSource.getUrl());

        FakeJmsBrocker fakeJmsBrocker = ctx.getBean(FakeJmsBrocker.class);

        System.out.println("  name: " + fakeJmsBrocker.getUsername() + ",\n" +
                "  pass: " + fakeJmsBrocker.getPassword() + ", \n" +
                "  url:  " + fakeJmsBrocker.getUrl());
    }
